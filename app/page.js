  ...
  return (
    <div className="flex flex-col items-center w-full h-full lg:gap-5 lg:flex-row">
      ...
      <div className="flex flex-col items-center w-full gap-5 p-4 md:max-w-lg lg:max-w-xl">
        <div
          className={`${oxanium.className} text-3xl font-bold
    uppercase tracking-wider text-yellow-600`}
        >
          <p>What is the Enhance Group?</p>
        </div>
        <div className="h-fit w-fit md:flex md:flex-col md:justify-center lg:flex lg:w-full">
          <div className="space-y-2 text-base indent-4 text-neutral-300">
            <span className="font-bold text-yellow-600">Enhance </span>
            <span>
              is a dynamic research group specializied in sports and esports
              management.
            </span>
            <p>
              Covering a diverse variety of topics our group brings together a
              team of researchers with a wide range of expertise.
            </p>
            <p>
              Our collaborative approach enables us to explore these themes
              comprehensively and develop innovative solutions across various
              domains within sports and esports management.
            </p>
          </div>
        </div>
        <div
